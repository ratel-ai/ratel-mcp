...
function CommandInput({
  ...
  return (
    <div data-slot="command-input-wrapper" className="px-3 pt-3.5 pb-2.5">
      <InputGroup className="h-8! rounded-lg! border-input bg-muted/35 shadow-inner shadow-background/60 *:data-[slot=input-group-addon]:pl-2!">
